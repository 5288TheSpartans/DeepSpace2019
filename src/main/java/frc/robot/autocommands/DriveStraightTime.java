...
public class DriveStraightTime extends Command {
  ...
  double startTimeInMilliseconds = 0;
  double currentTimeInMilliseconds = 0;
  double m_timeInMilliseconds = 0;
  double deltaTimeInMilliseconds = 0;
  double error = 0;
  double gain = 0;
  SpartanPID straightPID;

  public DriveStraightTime(double basePower, double timeInMilliseconds) {
  ...
  protected void initialize() {
    // 12039128410248
    // if the current time is 12039128410248 + 4 seconds (timeInMilliseconds)
    // return true
  ...
  protected void execute() {
    ...
    deltaTimeInMilliseconds = System.currentTimeMillis() - startTimeInMilliseconds;
  ...
  protected boolean isFinished() {
    ...
    if (deltaTimeInMilliseconds >= m_timeInMilliseconds)
      return true;
    else
      return false;
  }
